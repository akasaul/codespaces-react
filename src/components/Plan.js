  ...
  return (
    <article className='bg-white sm:max-w-[500px] -mt-24 min-w-[270px] flex flex-col space-y-2 sm:shadow-none shadow w-[80%] mx-auto px-4 py-6 rounded-xl'>
        ...
        <section className='flex flex-col mb-5 sm:space-y-0 sm:space-x-5 space-y-6 sm:flex-row'>
            {/* Plan  */}
            <div className={`bg-white p-3 sm:flex-col sm:items-start  sm:space-x-0 sm:justify-between sm:w-36 shadow border flex space-x-6 hover:bg-alabaster rounded-xl hover:outline-2 hover:border-purplish-blue ${data.plan === 0 && "bg-alabaster rounded-xl outline-2 border-purplish-blue" }`} onClick={() => setData({...data, plan: 0})}>
            ...
            {/* Plan  */}
            <div className={`bg-white p-3 sm:flex-col sm:items-start  sm:space-x-0 sm:justify-between sm:w-36 shadow border flex space-x-6 hover:bg-alabaster rounded-xl hover:outline-2 hover:border-purplish-blue ${data.plan === 1 && "bg-alabaster rounded-xl outline-2 border-purplish-blue" }`} onClick={() => setData({...data, plan: 1})}>
            ...
            {/* Plan  */}
            <div className={`bg-white p-3 sm:flex-col sm:items-start  sm:space-x-0 sm:justify-between sm:w-36 shadow border flex space-x-6 hover:bg-alabaster rounded-xl hover:outline-2 hover:border-purplish-blue ${data.plan === 2 && "bg-alabaster rounded-xl outline-2 border-purplish-blue" }`} onClick={() => setData({...data, plan: 2})}>
